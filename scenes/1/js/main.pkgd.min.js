...
(function(){"use strict";var e=Backbone.Model.extend({initialize:function(){this.set("single-page-width",parseInt($("#pages").css("max-width"))),this.set("format",{}),this.set("zoom",null)},setPageFormat:function(e){this.set("format",this.determineLayoutInformation(e))},determineLayoutInformation:function(e){var t=this.determineBookend(e),a=this.determinePageFormat();return{format:a,bookend:t}},determinePageFormat:function(e){e=e||$(window).width();var t,a=parseInt($(".page-container.viewing img").css("width"))||parseInt($(".page-container img").css("width")),o=g.singlePageWidthLimit;return t=e>2*a+parseInt(g.gutterWidth)?"double":e<=o?"mobile":"single"},determineBookend:function(e){var t,o=e||a.currentPage;return t=1==o?"true":"false"}}),t=new e,a={currentPage:"1",currentHotspot:"",lastPage:"",lastHotspot:"",scaleMultiplier:1,firstRun:!0,showNavHelpers:!0},o={setTransitionCss:function(e,t,a){var n={};return n[e]=t,n=o.addDuration(n,a)},addDuration:function(e,t,a){var o;return o=a?a:t?g.transitionDuration:0,_.extend(e,{"transition-duration":o}),e},saveCurrentStates:function(e,o,n){var r=t.get("format"),i=r.format,s=r.bookend;"double"==i&&"false"==s&&e%2!=0&&(e-=1),e&&(a.currentPage=e),o&&(a.currentHotspot=o),n&&(a.lastPage=n)},hashToPageHotspotDict:function(e){return e=e.replace("#","").split("/"),e=_.map(e,function(e){return Number(e)}),{page:e[0],hotspot:e[1]}},getNavDirection:function(e,t){var a;return(37==t||38==t||39==t||40==t||"swipeleft"==t||"swiperight"==t)&&(e.preventDefault(),e.stopPropagation(),37==t||"swiperight"==t?a="prev":39==t||"swipeleft"==t?a="next":27!=t&&38!=t&&40!=t||(a=!1),a)},toggleFullScreen:function(){document.fullScreenElement&&null!==document.fullScreenElement||!document.mozFullScreen&&!document.webkitIsFullScreen?document.documentElement.requestFullScreen?document.documentElement.requestFullScreen():document.documentElement.mozRequestFullScreen?document.documentElement.mozRequestFullScreen():document.documentElement.webkitRequestFullScreen&&document.documentElement.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()},sortByNumber:function(e,t){return e.number-t.number},toggleHoverZoom:function(){var e=$('.header-item-container[data-btn="enable-zoom"]');e.toggleClass("active"),e.hasClass("active")||($(".page-container.viewing img,.page-container.viewing .paragraph-text").css({transform:"translate(0,0)scale(1)","transition-delay":"0"}),$(".page-container.viewing .paragraph-text").css({transform:"translate(0,0)scale(1)","transition-delay":"0"}))}},n={pageFactory:_.template($("#page-template").html()),endnoteFactory:_.template($("#endnote-template").html())},r={init:function(){this.mainContent="#main-content-wrapper",this.drawerContainer="#side-drawer-container",this.drawerContent="#side-drawer-content",this.drawerHandle="#side-drawer-handle",this.pubDate=".pub-date-js",$.detectSwipe.scrollExceptionCondition=function(){return"true"==$("body").attr("data-side-drawer-open")||"changing"==$("body").attr("data-side-drawer-state")},this.slideContentArea(!0),this.bakePubDate()},bakeMasks:function(){$("#pages").append('<div class="mask" data-orientation="horizontal" id="top-mask"></div>').append('<div class="mask" data-orientation="horizontal" id="bottom-mask"></div>').append('<div class="mask" data-orientation="vertical" id="left-mask"></div>').append('<div class="mask" data-orientation="vertical" id="right-mask"></div>')},bakePages:function(e){var t,s;a.pages_max=e.length,e=e.sort(o.sortByNumber);var d=$('.header-item[data-which="page-number"]');d.find("#pages-max").html(a.pages_max),d.find("input").attr("max",a.pages_max);for(var l=0;l<e.length;l++)_.extend(e[l],{img_format:g.imgFormat}),t=n.pageFactory(e[l]),$("#pages").append(t),s=$("#page-"+e[l].number),i.hotspotClicks(s),i.pageTransitions();$("#page-container-"+a.pages_max).css("z-index","1000"),i.state(),r.measurePageElements(function(){c.init()})},measureHotspotsHeaderOffset:function(){$("#pages").attr("data-offset-top",$("#pages").offset().top),$(".hotspot").each(function(e,t){var a=$(t);a.attr("data-top",a.offset().top),a.attr("data-left",a.offset().left),a.attr("data-width",a.width()),a.attr("data-height",a.height())})},measurePageElements:function(e){r.measureImgSetPageHeight(function(){r.measureHotspotsHeaderOffset(),e()})},measureImgSetPageHeight:function(e){var o=$("#pages"),n=$("#pages-wrapper"),r=$("#page-1 .hover-mask"),i={"max-width":"auto","max-height":"auto"};o.css(i),n.css(i),r.css({"max-width":"100%",width:"100%",opacity:0}),o.imagesLoaded().done(function(){var i=o.find("img"),s=i.width(),d=s,c=s,l=i.height();g.original_img_width=d,t.setPageFormat();var u=t.get("format").format;"double"==u&&(s=2*s,c=s+parseInt(g.gutterWidth),"Firefox"==m.browser[0]&&(c-=1),1==a.currentPage?r.width(d):r.css("width",""));var p=[{el:o,width:s},{el:n,width:c}];_.each(p,function(e){e.el.css("max-width",e.width+"px").css("max-height",l+"px")}),$("#btns").css("height",l+"px");var h=_.max([960,s]);$("#header").css("max-width",h+"px"),r.css("opacity",1),e()})},implementPageFormat:{bookend:function(){"2"==a.currentPage?$("#page-container-3").addClass("exit-to-right").addClass("right-page"):"1"!=a.currentPage&&$("#page-container-"+(a.currentPage+1)).addClass("exit-to-right")},mobile:function(){this.single()},single:function(){$(".right-page").removeClass("viewing").removeClass("right-page")},"double":function(){var e,t;a.hotspot="",a.lastHotspot="",t=+a.currentPage,t%2!=0&&1!=t&&t--,e=$("#page-container-"+t),e.hasClass("right-page")&&e.removeClass("right-page"),e.addClass("viewing"),1!=t&&$("#page-container-"+(t+1)).addClass("right-page").addClass("viewing")}},update:function(){t.setPageFormat();var e=t.get("format"),n=e.format;2==a.currentPage&&"double"==n&&r.toggleNavHelpers(!1);var i=$("#page-"+a.currentPage);l.toPage(i,!1),r.measurePageElements(function(){c.set.prune();var e=window.location.hash;if(e){var t=o.hashToPageHotspotDict(e);r.showAppropriateNavBtns(t.page),c.read(t.page,t.hotspot,!1)}})},displayPageNumber:function(e){e=+e;var a=t.get("format"),o=a.format;"double"==o&&e>1&&e%2!=0&&(e-=1),$('.header-item[data-which="page-number"] .header-text input').val(e)},showAppropriateNavBtns:function(e){e=+e;var o,n=t.get("format").format;1==e?o="prev":(e==a.pages_max||"double"==n&&e==a.pages_max-1)&&(o="next"),$(".main-nav-btn-container").removeClass("full").css("display","inline-block"),o&&($('.main-nav-btn-container[data-dir="'+o+'"]').hide(),$('.main-nav-btn-container[data-dir="'+this.otherDir(o)+'"]').addClass("full"))},otherDir:function(e){return"prev"==e?"next":"next"==e?"prev":void 0},toggleNavHelpers:function(e){$(".nav-helpers").toggle(e)},navHelpersMode:function(e){$(".nav-helpers-child").hide(),$('.nav-helpers-child[data-mode="'+e+'"]').show()},toggleDesktopDrawer:function(){$("#desktop-drawer-container").toggle()},bakeEndnotes:function(e){e.sort(o.sortByNumber),_.each(e,function(e){var t=n.endnoteFactory({endnote:e});$(".endnotes").append(t)})},catchDrawerScroll:function(e){"true"==$("body").attr("data-side-drawer")&&(!$(r.drawerContent).has($(e.target)).length||$(r.drawerContent).height()<$(r.drawerContainer).height())&&(e.preventDefault(),r.slideContentArea())},slideContentArea:function(e){var t=$("body"),a=t.attr("data-side-drawer-state");a&&t.attr("data-side-drawer-state","changing"),e=e||"true"==t.attr("data-side-drawer-open"),t.attr("data-side-drawer-open",!e),_.delay(this.onDrawerTransitionEnd,parseInt(g.drawerTransitionDuration))},onDrawerTransitionEnd:function(e){$("body").attr("data-side-drawer-state","stable")},dragDrawer:function(e){e.preventDefault(),e.stopPropagation();var t=e.originalEvent,a=Number(t.changedTouches[0].pageX);this.last_x=this.last_x||a;var o=this.last_x-a,n=+$("#main-content-wrapper").css("transform").match(/(-?[0-9\.]+)/g)[4];return $('body[data-side-drawer-open="true"] #main-content-wrapper').css({"transition-duration":"0",transform:"translateX("+(n-o)+"px)"}),this.last_x=a,$('.header-item-container[data-action="drawer"]').removeClass("active"),!1},snapDrawer:function(){this.last_x=!1,$(r.mainContent).css({"transition-duration":g.drawerTransitionDuration,transform:"auto"}),$('.header-item-container[data-action="drawer"]').removeClass("active"),r.slideContentArea(!0)},goToPage:{focus:function(e,t){},navigate:function(e,t){var a=t.toString();e?c.router.navigate(a,{trigger:!0}):r.displayPageNumber(t),r.goToPage.focus(!1)},deny:function(){var e=a.currentPage;r.displayPageNumber(e)}},fullScreenChange:function(){document.fullScreenElement&&null!==document.fullScreenElement||!document.mozFullScreen&&!document.webkitIsFullScreen},bakePubDate:function(){$(this.pubDate).html(g.pubDate)}},i={header:function(){$('.header-item-container[data-btn="fullscreen"]').on("click",function(){o.toggleFullScreen()}),$('.header-item-container[data-btn="enable-zoom"]').on("click",function(){o.toggleHoverZoom()}),$('.header-item-container[data-action="drawer"], .section-title-close[data-action="drawer"]').on("click",function(){$('.header-item-container[data-action="drawer"]').toggleClass("active"),r.slideContentArea()}),$(".tooltipped-i input").on("focus",function(){var e=this;if(!window.getSelection().focusNode)try{e.setSelectionRange(0,999)}catch(t){$(e).select()}}),$(".tooltipped-i input").on("blur",function(){r.goToPage.deny()}),$('.header-item[data-which="page-number"] input').on("keydown",function(e){e.stopPropagation()}),$('.header-item[data-which="page-number"] input').on("keyup",function(e){e.stopPropagation();var t=+$(this).val()||1,o=e.keyCode,n=a.currentPage,i=n!=t;t<1?t=1:t>a.pages_max&&(t=a.pages_max),r.goToPage.focus(i,!0),t&&13===o?(r.goToPage.navigate(i,t),$(".tooltipped-i input").blur()):27==o&&r.goToPage.deny()}),$(".social-btn").on("click",function(e){var t=$(this).attr("data-which");u.share[t](e)})},resize:function(){r.updateDebounce=_.debounce(r.update,500),window.addEventListener("resize",function(){r.updateDebounce()})},state:function(){t.on("change:format",function(e,t){$("body").attr("data-format",t.format),$("body").attr("data-bookend",t.bookend),"false"==t.bookend?r.implementPageFormat[t.format]():r.implementPageFormat.bookend()}),t.on("change:zoom",function(e,t){$("body").attr("data-state",t)})},hotspotClicks:function(e){e.on("click",".hotspot",function(){c.set.fromHotspotClick($(this))})},keyboardAndGestures:function(){function e(e,t,a){e.attr("data-canzoom",t),t&&clearTimeout(i)}function n(e){var o=t.get("format"),n=o.format,r=o.bookend;if($('.header-item-container[data-btn="enable-zoom"]').hasClass("active")&&"mobile"!=n&&"page-change"!=$("body").attr("data-state")&&"true"==$(this).attr("data-canzoom")&&"false"==$(this).attr("data-mouseout")){var i,s,d=g.desktopHoverZoomOptions.scale,c=100*g.desktopHoverZoomOptions.fit,l=g.desktopHoverZoomOptions.padding,u=$(this),p=u.find("img"),m=p.width(),h=u.width(),f=u.height(),v=e.pageX-u.offset().left,w=e.pageY-u.offset().top,b=v/h,k=w/f;if(r&&"double"==n&&1==a.currentPage){if(i=(h-m)/2,s=i+m,v<i||v>s)return this.style.cursor="default",!0;h=h/2-parseInt(g.gutterWidth)}var C=c*((h*d-h)/2)/h,P=(new Scale).domain(1-l,l).range(-1*C,C,!0),x=P(b),y=P(k),S="true"==u.attr("data-iszoom")?g.desktopHoverZoomOptions.mouseFollowSpeed:g.desktopHoverZoomOptions.zoomInSpeed,H=_.extend({transform:"matrix("+d+", 0, 0, "+d+", "+x/100*h+", "+y/100*f+")"},{"transition-delay":"0","transition-duration":S,"transition-timing-function":"cubic-bezier(0, 0, .2, 1)"});p.css(H),u.find(".paragraph-text").css(H),u.attr("data-iszoom",!0)}}if($("body").keydown(function(e){var t=o.getNavDirection(e,e.keyCode);c.set.fromKeyboardOrGesture(t)}),$(document).on("swipeleft",function(e){var t=o.getNavDirection(e,"swipeleft");c.set.fromKeyboardOrGesture(t)}),$(document).on("swiperight",function(e){var t=o.getNavDirection(e,"swiperight");c.set.fromKeyboardOrGesture(t)}),$(document).on("pinchin pinchout",function(e){var t=a.currentPage,o=a.currentHotspot||"1",n=$('<div class="dummy-hotspot" data-hotspot-id="'+t+"-"+o+'"></div>');c.set.fromHotspotClick(n),n.remove()}),$(".main-nav-btn-container").on("click",function(){var e=$(this).attr("data-dir");c.set.fromKeyboardOrGesture(e)}),$("#pages").on("click",".mask",function(){c.set.fromHotspotClick($(this))}),$("#pages").on("click",'.internal-link[data-destination="endnotes"]',function(){$('.header-item-container[data-action="drawer"]').toggleClass("active"),r.slideContentArea()}),"desktop-hover"==g.panelZoomMode){var i,s=_.throttle(n,parseInt(g.desktopHoverZoomOptions.zoomInDelay),{leading:!1});$("#pages").on("mouseover",".page",function(){var a=t.get("format"),o=a.format;$('.header-item-container[data-btn="enable-zoom"]').hasClass("active")&&"mobile"!=o&&(e($(this),!0),$(this).attr("data-mouseout",!1))}),$("#pages").on("mouseout",".page",function(){var a=t.get("format"),o=a.format;if($('.header-item-container[data-btn="enable-zoom"]').hasClass("active")&&"mobile"!=o){var n=_.extend({transform:"translate(0%,0%)scale(1)"},{"transition-delay":g.desktopHoverZoomOptions.zoomOutDelay,"transition-duration":g.desktopHoverZoomOptions.zoomOutSpeed,"transition-timing-function":"ease-out"}),r=$(this);r.find("img").css(n),r.find(".paragraph-text").css(n),r.attr("data-mouseout",!0),i=setTimeout(function(){e(r,!1),r.attr("data-iszoom",!1),r.attr("data-mouseout",!1)},parseInt(g.desktopHoverZoomOptions.zoomOutDelay))}}),$("#pages").on("mousemove",".page",function(e){"true"==$(this).attr("data-iszoom")?n.call(this,e):s.call(this,e)})}},pageTransitions:function(){$(".page-container").on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd",d.onAnimationEnd_throttled)},drawer:function(){new ScrollFix(document.getElementById("side-drawer-container")),$("body").on("touchmove",r.catchDrawerScroll),$(r.drawerHandle).on("touchstart touchmove",r.dragDrawer),$(r.drawerHandle).on("touchend",r.snapDrawer),$(r.drawerHandle).on("click",r.snapDrawer)},fullscreen:function(){document.addEventListener("webkitfullscreenchange",r.fullScreenChange,!1),document.addEventListener("mozfullscreenchange",r.fullScreenChange,!1),document.addEventListener("fullscreenchange",r.fullScreenChange,!1),document.addEventListener("MSFullscreenChange",r.fullScreenChange,!1)}},s={prev:{page:function(e){var o=t.get("format"),n=o.format,r=o.bookend;return 1!=e.page&&("double"!=n&&"false"==r?e.page--:2!=e.page?e.page=e.page-2:e.page=e.page-1),e.hotspot="",a.lastHotspot="",e},hotspot:function(e){var t;return e.hotspot--,e.hotspot<0?(e.hotspot="",1!=e.page&&(e.page--,t=Number($("#page-"+e.page).attr("data-length")),t&&(a.lastHotspot=t+1))):e.hotspot<1&&(a.lastHotspot="",e.hotspot=""),e}},next:{page:function(e,o,n){var r=1,i=t.get("format"),s=i.format,d=i.bookend;return"double"==s&&"false"==d&&(r=2),e.page+r<=n&&(e.page=e.page+r,a.lastHotspot=""),e.hotspot="",e},hotspot:function(e,t,a){return e.hotspot++,e.hotspot>t&&(e=s.next.page(e,null,a)),e}}},d={goIfNecessary:function(e,a){var o=t.get("format"),n=o.format,i=o.bookend;"double"==n&&"false"==i&&a%2!=0&&(a-=1,c.router.navigate(a.toString(),{replace:!0}),r.displayPageNumber(a));var s=$("#page-1 .hover-mask");1==a?s.width(g.original_img_width):s.css("width","");var l=this.determineTransition(e,a,n,i);l&&d.movePages(e,a,l)},determineTransition:function(e,t,a,o){var n;return"double"==a&&e-t==1&&"false"==o||e!=t&&(n=e<t?d.moveForward():d.moveBack()),n},moveForward:function(){var e={exiting:"exit-to-left",entering:"enter-from-right"};return e},moveBack:function(){var e={exiting:"exit-to-right",entering:"enter-from-left"};return e},movePages:function(e,a,o){var n=t.get("format").format,r=t.get("format").bookend;if("double"!=n||"true"==r)$("#page-container-"+e).addClass(o.exiting),$("#page-container-"+a).addClass(o.entering);else{var i="";1==e&&(i=" center-page"),$("#page-container-"+e).addClass(o.exiting+i),$("#page-container-"+(e+1)).addClass(o.exiting),$("#page-container-"+a).addClass(o.entering).addClass("viewing"),$("#page-container-"+(a+1)).addClass(o.entering).addClass("right-page").addClass("viewing")}},onAnimationEnd:function(){$(".page-container").removeClass("enter-from-left").removeClass("enter-from-right").removeClass("exit-to-left").removeClass("exit-to-right").removeClass("center-page"),$("#page-container-"+a.lastPage).removeClass("viewing").find(".page").css(o.setTransitionCss("transform","scale(1)",!1));var e=t.get("format"),n=e.format,r=e.bookend;"double"==n&&"false"==r&&1!=a.lastPage?$("#page-container-"+(+a.lastPage+1)).removeClass("viewing").removeClass("right-page").find(".page").css(o.setTransitionCss("transform","scale(1)",!1)):"true"==r&&1==a.currentPage&&$("#page-container-"+(+a.lastPage+1)).removeClass("viewing").removeClass("right-page"),t.set("zoom","page")}},c={setInitRouteChecks:function(e,n,i){var s=!0,d=t.get("format"),c=d.format;if(n=n||a.firstRun,a.firstRun){var l=!1;(g.requireStartOnFirstPage||"1"==e)&&(e="1",l=!0),o.saveCurrentStates(e),s=!1,r.toggleNavHelpers(l),r.navHelpersMode("intro")}else a.showNavHelpers&&"2"==e&&"single"==c?(r.navHelpersMode("expand"),a.showNavHelpers=!1):r.toggleNavHelpers(!1);n&&this.lazyLoadImages(e),r.displayPageNumber(e),r.showAppropriateNavBtns(e),i(s,e)},lazyLoadImages:function(e){e=+e;var t=g.lazyLoadExtent,o=e-t,n=e+t;o<=0&&(o=1),n>a.pages_max&&(n=a.pages_max+1);for(var r,i,s,d,c,l,u=_.range(o,n),p=0;p<u.length;p++)r=u[p],i=$("#page-container-"+r),s=i.find("img"),l=s.attr("src"),l.indexOf("data:image/gif")>-1&&(d=r+"."+g.imgFormat,c="imgs/pages/page-"+d,s.attr("src",c))},init:function(){c.Router=Backbone.Router.extend({routes:{":page(/)":"page",":page/:hotspot":"hotspot"}}),c.router=new c.Router,c.router.on("route:page",function(e){c.setInitRouteChecks(e,!0,function(e,t){c.read(t,null,e)})}),c.router.on("route:hotspot",function(e,a){c.setInitRouteChecks(e,null,function(o){"mobile"!=t.get("format").format&&(a=null,c.router.navigate(e,{replace:!0})),c.read(e,a,o)})}),Backbone.history.start(),c.onPageLoad(window.location.hash)},onPageLoad:function(e){var t;t=!e||g.requireStartOnFirstPage?"1":a.currentPage,c.router.navigate(t.toString(),{trigger:!0,replace:!0})},set:{fromHotspotClick:function(e){if("mobile"==t.get("format").format){var o=e.attr("data-hotspot-id").split("-"),n=o[0],r=o[1],i="";a.currentPage==n&&a.currentHotspot==r?(a.lastHotspot=r,a.currentHotspot=r="",i=n):i=n+"/"+r,c.router.navigate(i,{trigger:!0})}},fromKeyboardOrGesture:function(e){if(e&&"page-change"!=$("body").attr("data-state")){var n,r=o.hashToPageHotspotDict(window.location.hash),i=Number($("#page-"+r.page).attr("data-length")),d=t.get("format"),l=d.format;r.page=r.page||1,r.hotspot=r.hotspot||a.lastHotspot||0,a.lastHotspot=r.hotspot,n="mobile"==l?"hotspot":"page",r=s[e][n](r,i,a.pages_max);var u=r.page.toString();r.hotspot&&(u+="/"+r.hotspot),c.router.navigate(u,{trigger:!0})}},prune:function(){var e=o.hashToPageHotspotDict(window.location.hash);"mobile"!=t.get("format").format&&e.hotspot&&(c.router.navigate(e.page.toString(),{replace:!0}),a.currentHotspot="")}},read:function(e,n,r){var i=$("#page-container-"+e);i.hasClass("viewing")||i.addClass("viewing"),a.firstRun&&(o.saveCurrentStates(e,n),a.firstRun=!1),e=+e,t.setPageFormat(e),d.goIfNecessary(+a.currentPage,e),"mobile"==t.get("format").format&&n?l.toHotspot(e,n,r):l.toPage($("#page-"+e),!0),o.saveCurrentStates(e,n,a.currentPage)}},l={toPage:function(e,a){var n=o.setTransitionCss("transform","scale(1)",a);e.css(n);var r={opacity:0},i=_.extend({height:0},r),s=_.extend({width:0},r);i=o.addDuration(i,a),s=o.addDuration(s,a),$('.mask[data-orientation="horizontal"]').css(i),$('.mask[data-orientation="vertical"]').css(s);var d,c,l=t.get("format"),u=l.format;c="double"!=u?1:2;var g=$(".viewing").length;g==c?d="page":g>c&&(d="page-change"),t.set("zoom",d)},toHotspot:function(e,n,r){var i=$("#page-"+e),s=i.width(),d=i.height(),c=$(window).width()/2,u=d/2,g=+$("#pages").attr("data-offset-top"),p=$("#hotspot-"+e+"-"+n),m=Number(p.attr("data-top")),h=Number(p.attr("data-left")),f=Number(p.attr("data-width")),v=Number(p.attr("data-height")),w=f/2,b=v/2,k=this.calcScaleMultiplier(f,v,s,d),C=k.multiplier,P=k.orientation,x=c-h-w,y=u-m-b+g,S=o.setTransitionCss("transform","scale("+C+") translate("+x+"px, "+y+"px)",r);i.css(S),l.sizeMasks(f,v,s,d,C,r,P),l.applyHotspotIdToMasks(e,n),a.scaleMultiplier=C,t.set("zoom","hotspot")},sizeMasks:function(e,t,a,n,r,i,s){var d,c,l,u;"horizontal"==s?(d="height",c=(n-t*r)/2,l="vertical",u="width"):"vertical"==s&&(d="width",c=(a-e*r)/2,l="horizontal",u="height");var g={opacity:1};g[d]=c+"px",g=o.addDuration(g,i),$('.mask[data-orientation="'+s+'"]').css(g);var p={opacity:0};p[u]=0,p=o.addDuration(p,i),$('.mask[data-orientation="'+l+'"]').css(p)},applyHotspotIdToMasks:function(e,t){$(".mask").attr("data-hotspot-id",e+"-"+t)},calcScaleMultiplier:function(e,t,a,o){var n,r,i=["horizontal","vertical"],s=[];s.push(1/(e/a)),s.push(1/(t/o)),n=_.min(s);var d=s.indexOf(n);return r=i[d],{multiplier:n,orientation:r}}},u={init:function(){this.shareable_url="http://"+window.location.hostname+window.location.pathname},share:{twitter:function(e,t,a){var o="https://twitter.com/intent/tweet?url="+u.shareable_url;t=t||g.social.twitter_text,a&&(o+=a);var n="&text="+t,r=g.social.twitter_account,i="&related="+r,s="&counturl="+u.shareable_url,d=e.pageX-400,c=e.pageY-350,l=u.percentEncode(o+n+" via @"+r+i+s),p="width=500,height=300,top="+c+",left="+d+",scrollbars=no,location=0,statusbars=0,menubars=0,toolbars=0,resizable=0";window.open(l,"Tweet",p)},facebook:function(e,t,a){var o="http://www.facebook.com/dialog/feed",n="?app_id="+g.social.fb_app_id,r="&link="+u.shareable_url;t=t||g.social.fb_text,a=a||g.social.promo_img_url;var i="&description="+t,s="&redirect_uri="+u.shareable_url,d="&image="+a,c=o+n+r+i+s+d,l=e.pageX-400,p=e.pageY-350,m=u.percentEncode(c),h="width=900,height=450,top="+p+",left="+l+",scrollbars=no,location=0,statusbars=0,menubars=0,toolbars=0,resizable=0";window.open(m,"Share",h)},gplus:function(e){var t="https://plus.google.com/share",a="?url="+u.shareable_url,o=t+a,n=u.percentEncode(o),r="width=600,height=600,scrollbars=yes,resizable=yes,toolbar=no,menubar=no";window.open(n,"Share",r)},reddit:function(e){var t="https://www.reddit.com/submit",a="?url="+u.shareable_url,o=t+a,n=u.percentEncode(o),r="width=600,height=600,scrollbars=yes,resizable=yes,toolbar=no,menubar=no";window.open(n,"Share",r)}},percentEncode:function(e){return e.replace(/#/g,"%23").replace(/,/g,"%2c").replace(/ /g,"%20")}},g={},p={init:function(e){$.getJSON("config.json").done(function(t){g=$.extend(!0,p.defaults,t),e()}).error(function(e){e&&alert("Error loading config. File is either missing or the JSON is malformed. Try running `config.json` it through jsonlint.com: "+JSON.stringify(e.message))})},defaults:{imgFormat:"jpg",whitelabel:{files:{js:[]},logo:""},panelZoomMode:"desktop-hover",desktopHoverZoomOptions:{scale:1.5,fit:1,padding:.25},lazyLoadExtent:6,transitionDuration:400,singlePageWidthLimit:635,gutterWidth:"2px",drawerTransitionDuration:500,social:{twitter_text:"THE TEXT TO DISPLAY WHEN SOMEONE CLICKS ON THE TWEET BUTTON",twitter_account:"THE RELATED TWITTER ACCOUNT.",fb_text:"THE TEXT TO DISPLAY WHEN SOMEONE CLICKS ON THE FACEBOOK SHARE BUTTON",promo_img_url:"PUBLISHED URL FOR IMAGE TO USE AS SOCIAL PROMO",fb_app_id:"YOUR FB APP ID"},requireStartOnFirstPage:!1}},m={go:function(){var e=this;p.init(function(){e.whitelabel(g.whitelabel),d.onAnimationEnd_throttled=_.throttle(d.onAnimationEnd,5),e.browser=e.browserCheck(),e.touch=e.touchCheck(),e.addMobileClass(),e.addPanelZoomModeClass(),r.init(),r.bakeMasks(),e.loadPages(),i.resize(),i.header(),i.keyboardAndGestures(),i.drawer(),i.fullscreen(),u.init(),FastClick.attach(document.body),e.browserHacks()})},loadPages:function(){$.getJSON("data/pages.json").done(function(e){var t=e.pages,o=e.endnotes;a.totalPages=t.length,r.bakePages(t),r.bakeEndnotes(o)}).error(function(e){e&&alert("Error loading data. Data file is either missing or the JSON is malformed. Try running `pages.json` through jsonlint.com: "+JSON.stringify(e.message))})},browserCheck:function(){var e,t=navigator.userAgent,a=t.match(/(android|opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(a[1])?(e=/\brv[ :]+(\d+)/g.exec(t)||[],"IE "+(e[1]||"")):"Chrome"===a[1]&&(e=t.match(/\bOPR\/(\d+)/),null!=e)?"Opera "+e[1]:(a=a[2]?[a[1],a[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(e=t.match(/version\/(\d+)/i))&&a.splice(1,1,e[1]),a)},whitelabel:function(e){e&&$("#header").append(e.logo)},browserHacks:function(){"Android"==this.browser[0]&&$("#page-number-input").attr("type","text"),this.touch&&$(".nav-helpers").remove()},touchCheck:function(){return"ontouchstart"in window||"onmsgesturechange"in window},addMobileClass:function(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&$("body").addClass("mobile")},addPanelZoomModeClass:function(){$("body").attr("data-panel-zoom-mode",g.panelZoomMode)}};m.go()}).call(this);
